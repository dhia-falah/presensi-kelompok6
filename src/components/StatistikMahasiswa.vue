<template>
  <div class="app">
    <div class="border2">
      <center><a href="/siswa">presensi</a></center>
...
export default {
  ...
  methods: {
    ...
    load() {
      ...
      axios
        .get("http://localhost:3000/useres")
        .then((res) => {
          this.info = res.data;
        })
        .catch((err) => {
    ...
    add() {
      axios.post("http://localhost:3000/useres", this.form).then((res) => {
        this.load();
        (this.form.id = ""),
          (this.form.nama = ""),
          (this.form.tanggal = ""),
    ...
    update(form) {
      return axios
        .put("http://localhost:3000/useres" + form.id, {
          nama: this.form.nama,
    ...
    del(user) {
      axios.delete("http://localhost:3000/useres" + user.id).then((res) => {
        this.load();
